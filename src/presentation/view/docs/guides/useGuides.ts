  ...
  const guides = [
    {
      ...
      items: [
        ...
        { title: 'Quick Start with Partner Flow', description: 'Start with create-payment, hosted read, and resolve-code.', href: '/docs/partner-api', readTime: '8 min', difficulty: 'Beginner', tags: ['setup'] },
    ...
    },
    {
      ...
      items: [
        ...
        { title: 'Custom Partner Integration', description: 'Build a full partner integration using partner HMAC auth and create-payment orchestration flow.', href: '/docs/partner-api', readTime: '20 min', difficulty: 'Intermediate', tags: ['api', 'custom'] },
